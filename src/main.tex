...
MPI with the job scheduler of the cluster. Specifically, we develop a plugin
for the scheduler that collects and reports the job information to the
interconnect controller. A preliminary evaluation demonstrated that
applications can gain up to 2.56$\times$ speedup in communication.
}
