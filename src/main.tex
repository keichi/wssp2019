...
manager computes the optimal routing for based on these information. The
computed routing is then installed through the OpenFlow controller to each
switch in the interconnect.
...
\begin{table}
\caption{Communication benchmarks used in the evaluation}%
...
two quad-core Intel Xeon E5520 CPUs. A single NEC PF5240 OpenFlow switch is
divided into six virtual switches to compose a fat-tree topology.
